...
<head>
  ...
  <title>Aplikasi Pelaporan Pengaduan Masyarakat - Blank</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="masyarakat.php?url=lihat-pengaduan">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Aplikasi Pelaporan Pengaduan Masyarakat Parhan&copy2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
